                        ...
                        <div className="Grid--Row">
                            <div className="Grid--Item">
                                <Widget
                                    styleName="warning"
                                    align="center"
                                    value={globalData.cases.toLocaleString("en-KE")} // .toLocaleString(navigator.language, { minimumFractionDigits: 0 })
                            ...
                            <div className="Grid--Item">
                                <Widget
                                    styleName="success"
                                    align="center"
                                    value={globalData.recovered.toLocaleString("en-KE")}
                                    label="Recovered"
                                />
                            </div>
                            <div className="Grid--Item">
                                <Widget
                                    styleName="danger"
                                    align="center"
                                    value={globalData.deaths.toLocaleString("en-KE")}
                                    label="Deaths"
                                />
                            </div>
                        </div>
